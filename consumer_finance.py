...
if __name__ == '__main__':
    ...
    for ticker in set(data['Ticker']):
        ...
        plt.plot(ticker_data['Time'], ticker_data['Open'], label='Open')
        plt.plot(ticker_data['Time'], ticker_data['High'], label='High')
        plt.plot(ticker_data['Time'], ticker_data['Low'], label='Low')
        plt.plot(ticker_data['Time'], ticker_data['Close'], label='Close')
        plt.plot(ticker_data['Time'], ticker_data['Volume'], label='Volume')
